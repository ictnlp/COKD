...
class FairseqTask(object):
    ...
    def train_step(self, sample, model, criterion, optimizer, ignore_grad=False, teachers = None):
        """
        ...
        if teachers is not None:
            loss, sample_size, logging_output = criterion(model, sample, teachers=teachers)
        else:
